  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FDFCFB] text-[#1E1E1E] selection:bg-[#FEDFD9] selection:text-[#1E1E1E]">
      ...
      <header className="border-b border-[#1E1E1E] bg-[#FDFCFB] sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-bold">
            ...
            <Link href="/analytics" className="hover:text-[#F86041] hover:underline border border-[#1E1E1E] px-4 py-1.5 bg-[#FEDFD9]">
              Analisis Dataset
            </Link>
          </nav>
          ...
          <Link
            href="/diagnose"
            className="px-6 py-3 border border-[#1E1E1E] bg-[#F86041] text-[#FDFCFB] hover:bg-[#1E1E1E] hover:text-[#FDFCFB] text-xs font-bold uppercase transition-colors"
          >
            Tes Mandiri
          </Link>
        </div>
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-6 py-20 flex flex-col justify-center gap-12">
        ...
        {/* Team Section */}
        <section className="mt-20 border-t border-[#1E1E1E] pt-16">
          <div className="mb-10">
            <h2 className="text-2xl font-bold">Tim Pengembang</h2>
            <p className="text-sm text-zinc-500 mt-2">Dosen Pengampu: Prof. Dr. Wiharto S.T., M.Kom.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="border border-[#1E1E1E] p-6 flex items-center gap-5 bg-[#FDFCFB]">
                <div className="w-12 h-12 border border-[#1E1E1E] bg-[#FEDFD9] flex items-center justify-center font-bold text-sm text-[#F86041]">
                  K2
                </div>
                <div>
                  <h4 className="font-bold text-sm">{member.name}</h4>
                  <p className="text-xs text-zinc-500 mt-1">{member.nim}</p>
                </div>
              </div>
            ))}
          </div>
